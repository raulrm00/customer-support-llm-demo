"""Pandera schemas for customer support datasets."""
...
class ProcessedCustomerSupportSchema(pa.DataFrameModel):
    """Schema for the cleaned Bitext customer support dataset."""

    instruction: str = pa.Field(nullable=False)
